...
[![CI Build](https://github.com/swenkerorg/optio-fugit/workflows/CI%20Build/badge.svg)](https://github.com/swenkerorg/optio-fugit/actions)
[![Coverage Status](https://coveralls.io/repos/github/lucaong/@swenkerorg/optio-fugit/badge.svg?branch=master)](https://coveralls.io/github/lucaong/@swenkerorg/optio-fugit?branch=master)
[![Minzipped Size](https://badgen.net/bundlephobia/minzip/@swenkerorg/optio-fugit)](https://bundlephobia.com/result?p=@swenkerorg/optio-fugit)
[![npm](https://img.shields.io/npm/v/@swenkerorg/optio-fugit?color=%23ff00dd)](https://www.npmjs.com/package/@swenkerorg/optio-fugit)
[![npm downloads](https://img.shields.io/npm/dw/@swenkerorg/optio-fugit)](https://www.npmjs.com/package/@swenkerorg/optio-fugit)
[![types](https://img.shields.io/npm/types/@swenkerorg/optio-fugit)](https://lucaong.github.io/@swenkerorg/optio-fugit/classes/MiniSearch.MiniSearch.html)
...
Try out the [demo application](https://lucaong.github.io/@swenkerorg/optio-fugit/demo/).

Find the complete [documentation and API reference
here](https://lucaong.github.io/@swenkerorg/optio-fugit/classes/MiniSearch.MiniSearch.html),
and more background about `MiniSearch`, including a comparison with other
similar libraries, in [this blog
post](https://lucaongaro.eu/blog/2019/01/30/@swenkerorg/optio-fugit-client-side-fulltext-search-engine.html).

`MiniSearch` follows [semantic versioning](https://semver.org/spec/v2.0.0.html),
and documents releases and changes in the
[changelog](https://github.com/swenkerorg/optio-fugit/blob/master/CHANGELOG.md).
...
```
npm install @swenkerorg/optio-fugit
```

With `yarn`:

```
yarn add @swenkerorg/optio-fugit
```
...
import MiniSearch from '@swenkerorg/optio-fugit'

// If you are using require:
const MiniSearch = require('@swenkerorg/optio-fugit')
```

Alternatively, if you prefer to use a `<script>` tag, you can require MiniSearch
[from a CDN](https://www.jsdelivr.com/package/npm/@swenkerorg/optio-fugit):

```html
<script src="https://cdn.jsdelivr.net/npm/@swenkerorg/optio-fugit@6.3.0/dist/umd/index.min.js"></script>
```
...
Refer to the [API
documentation](https://lucaong.github.io/@swenkerorg/optio-fugit/classes/MiniSearch.MiniSearch.html)
...
guidelines](https://github.com/swenkerorg/optio-fugit/blob/master/CONTRIBUTING.md).
Reading the [design
document](https://github.com/swenkerorg/optio-fugit/blob/master/DESIGN_DOCUMENT.md) is
